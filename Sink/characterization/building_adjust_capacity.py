...
from ...Error_Handling.error_building_adjust_capacity import PlatformBuildingAdjustCapacity
...
def building_adjust_capacity(in_var):
    ###############################################################
    # INPUT
    # error handling
    platform_data = PlatformBuildingAdjustCapacity(**in_var['platform'])
