...
def convert_aux(stream, hx_delta_T, orc_T_cond, orc_T_evap, hx_efficiency, power_fraction, intermediate_fluid, country,
    ...
    if intermediate_circuit == True:
        ...
        info_hx_intermediate = Add_HX(hx_stream_supply_temperature, hx_stream_target_temperature, stream['fluid'],
