...
def make_pairs(combinations, above_pinch,delta_T_min,perform_special_case):
    ...
    if perform_special_case == False:
            ...
            for index_stream_out in df_streams_out.index.values:
                for index_stream_in in df_streams_in.index.values:
                    if df_streams_out.loc[index_stream_out]['Split_Check'] == False and df_streams_in.loc[index_stream_in]['Split_Check'] == False:
                        if df_streams_out.loc[index_stream_out]['Match'] == False and df_streams_in.loc[index_stream_in]['Match'] == False:
                            ...
                            if df_streams_out.loc[index_stream_out]['mcp'] > df_streams_in.loc[index_stream_in]['mcp']:
                                ...
                                if (df_streams_out.loc[index_stream_out]['Closest_Pinch_Temperature'] + delta_T_min < df_streams_in.loc[index_stream_in]['Supply_Temperature'] and above_pinch is True) or (
                                    ...
                                    if (df_streams_out.loc[index_stream_out]['Closest_Pinch_Temperature'] + delta_T_min <= df_streams_in.loc[index_stream_in]['Closest_Pinch_Temperature'] and above_pinch is True):
            ...
            if pairs != []:
                for pair in pairs:
                    ...
                    if above_pinch == True:
                        ...
                        if new_row['mcp'] - split_cold_stream_mcp < 0:
                        ...
                        df_streams_out_copy.loc[cold_stream_index, ['mcp']] = round(split_cold_stream_mcp + .0, 5)
        ...
        for combination in combinations:
            ...
            for index_stream_out in df_streams_out.index.values:
                for index_stream_in in df_streams_in.index.values:
                    if df_streams_out.loc[index_stream_out]['Split_Check'] == False and \
                            df_streams_in.loc[index_stream_in]['Split_Check'] == False:
                        if df_streams_out.loc[index_stream_out]['Match'] == False and \
                                df_streams_in.loc[index_stream_in]['Match'] == False:
                            ...
                            if df_streams_out.loc[index_stream_out]['mcp'] > df_streams_in.loc[index_stream_in]['mcp']:
                                ...
                                if (df_streams_out.loc[index_stream_out]['Closest_Pinch_Temperature'] + delta_T_min <
                                    ...
                                    if (df_streams_out.loc[index_stream_out][
                                        'Closest_Pinch_Temperature'] + delta_T_min <=
                                            df_streams_in.loc[index_stream_in][
                                                'Closest_Pinch_Temperature'] and above_pinch is True):
                                        pairs += [[index_stream_out, index_stream_in]]

            if pairs != []:

                if above_pinch == True:
                    get_temperature = min(df_streams_out[df_streams_out['Reach_Pinch'] == False]['Closest_Pinch_Temperature'].values)
                ...
                for pair in pairs:
                    ...
                    if above_pinch == True:
                        ...
                        hx_cold_stream_T_cold = df_streams_out_copy.loc[index_stream_out]['Closest_Pinch_Temperature']
                        cold_stream_max_T_hot = get_temperature
                        cold_stream_mcp = df_streams_out_copy.loc[index_stream_out]['mcp']
                        cold_stream = df_streams_out_copy.loc[index_stream_out]
