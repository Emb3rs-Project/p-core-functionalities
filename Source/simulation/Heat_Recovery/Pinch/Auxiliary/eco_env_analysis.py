...
##############################
RETURN: array info_pinch with dictionaries for each pinch case. It is added a new key to each pinch case:

            # df_equipment_economic

            Where in df_equipment_economic, the following keys:
                # Equipment_ID - [ID]
                # Recovered_Energy - equipment total energy savings per year  [kWh]
                # CO2_Savings_Year - equipment total CO2  savings per year  [kg CO2/year]
                # Savings_Year - equipment total energy monetary savings per year  [€/year]
                # Total_Turnkey  - equipment total turnkey of pinch design  [€]
